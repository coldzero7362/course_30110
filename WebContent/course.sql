...
insert into COURSE_TBL values('40002','테스트',3,'2',5,1300,1600);
...
select a.id,a.name,a.credit, b.name,a.week,a.start_hour from course_tbl a,lecturer_tbl b  where a.lecturer = b.idx order by id asc;

select idx,name from lecturer_tbl;

update COURSE_TBL set col1=val1 from tablename where condition

select a.id,a.name,a.credit, b.name,a.week,a.start_hour from course_tbl a,lecturer_tbl b  where a.lecturer = b.idx order by id asc;

delete COURSE_TBL where id = '40002';